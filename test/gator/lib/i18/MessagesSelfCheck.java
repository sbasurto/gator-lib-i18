...
public final class MessagesSelfCheck {
    public static void main(String[] args) {
        ...
        assert "Aprobar".equals(spanish.getString("Approve"));
        assert "Desactivar".equals(spanish.getString("Deactivate"));
        assert "Crear".equals(spanish.getString("Create"));
        assert "Guardar".equals(spanish.getString("Save"));
        assert "Cancelar".equals(spanish.getString("Cancel"));
